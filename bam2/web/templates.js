...
$templateCache.put("../app/components/partials/details.html","<!-- Content Header (Page header) -->\n" +
    ...
    "                        <li class=\"list-group-item\" ng-show=\"component.short_desc != '' && component.short_desc != undefined\">\n" +
    "                            <span class=\"pull-left\"><b>Description</b></span> <span class=\"pull-right\" ng-bind=\"component.short_desc\"></span>\n" +
    "                        </li>\n" +
    ...
    "                        </li>\n" +
    "                        <li class=\"list-group-item\" ng-show=\"component.release_date != '' && component.release_date != undefined\">\n" +
    "                            <span class=\"pull-left\"><b>Release</b></span> <span class=\"pull-right\" ng-bind=\"component.release_date\"></span>\n" +
    "                        </li>\n" +
    ...
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"col-md-9 col-xs-8 col-sm-12\" ng-if=\"relnotes\">\n" +
    "            <div class=\"box\">\n" +
    ...
    "                </div>\n" +
    "                <div class=\"box-body\">\n" +
    "                   <span class=\"securityTabStyle\" ng-bind=\"relnotes\"></span>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "</section>")
...
$templateCache.put("../app/components/partials/detailspg95.html","<!-- Content Header (Page header) -->\n" +
    ...
    "                        <li class=\"list-group-item\" ng-show=\"component.short_desc\">\n" +
    "                            <span class=\"pull-left\"><b>Description</b></span> <span class=\"pull-right\" ng-bind=\"component.short_desc\" id=\"home_url\"></span>\n" +
    "                        </li>\n" +
    "                        <li class=\"list-group-item\" ng-show=\"component.home_url != '' && component.home_url != undefined || component.doc_url != '' && component.doc_url != undefined\">\n" +
    "                            <span class=\"pull-left\"><a ng-show=\"component.home_url != ''\" href=\"{{component.home_url}}\" target='_blank'> Homepage <i class=\"fa fa-external-link\"></i> </a></span> <span class=\"pull-right\"> <a ng-show=\"component.doc_url != ''\" href=\"{{component.doc_url}}\" target='_blank'> Documentation <i class=\"fa fa-external-link\"></i> </a> </span>\n" +
    "                        </li>\n" +
    ...
    "                                        </a>\n" +
    "\n" +
    "                                        <a class=\"btn btn-lg btn-default\" tooltip-append-to-body=\"true\" ng-disabled=\"true\" uib-tooltip=\"Coming soon\">\n" +
    ...
    "                                <div class=\"row\">\n" +
    "                                    <div class=\"col-md-12 col-xs-12\">\n" +
    "                                        <span class=\"securityTabStyle\" >{{relnotes}}</span>\n" +
    "                                    </div>\n" +
    "                                </div>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
...
$templateCache.put("../app/components/partials/pgInitialize.html","<div class=\"modal-header\">\n" +
    ...
    "	  	<div class=\"col-sm-6\">\n" +
    "	  		<input type=\"text\" class=\"form-control\" name=\"dataDir\" ng-model=\"dataDir\" value=\"{{dataDir}}\" />\n" +
    "	  	</div>\n" +
    "	  </div> -->\n" +
    "	  <div class=\"form-group\">\n" +
...
$templateCache.put("../app/components/partials/profiler.html","<section class=\"content-header\">\n" +
    ...
    "            </div>\n" +
    "            <div class=\"form-group\">\n" +
    "                <textarea ng-model=\"pgQuery\" required class=\"form-control\" placeholder=\"Report Query\"></textarea>\n" +
    "                <span class=\"required-plprofiler-form\">*</span>\n" +
    "            </div>\n" +
    "            <div class=\"form-group\">\n" +
    "                <input type=\"text\" ng-model=\"pgTitle\" required class=\"form-control\" placeholder=\"Report Title\">\n" +
    "                <span class=\"required-plprofiler-form\">*</span>\n" +
    "            </div>\n" +
    "             <div class=\"form-group\">\n" +
    "                <input type=\"text\" ng-model=\"pgDesc\" class=\"form-control\" placeholder=\"Report Desc\">\n" +
    "            </div>\n" +
    "            <div class=\"text-left\">\n" +
    ...
    "                            ng-disabled=\"!(hostName && pgUser && pgDB && pgPort && pgQuery && pgTitle)\"\n" +
...
$templateCache.put("../app/components/partials/status.html","<section class=\"content-header\">\n" +
    ...
    "                                    <a class=\"btn btn-default\" ng-show=\"comp.state =='Not Initialized' \" ng-click=\"openInitPopup(comp.component)\" ng-disabled=\" comp.showingSpinner != undefined\">Initialize</a>\n" +
...
$templateCache.put("../app/components/partials/view.html","<section class=\"content-header\">\n" +
    "    <server-info-details title=\"Update Manager\"></server-info-details>\n" +
...
$templateCache.put("../app/menus/partials/topMenu.html","<header class=\"main-header\">\n" +
    ...
    "                </a> -->\n" +
    "        <!-- Navbar Right Menu -->\n" +
    "        <h1 id=\"pgc-logo\">BigSQL Manager II</h1>\n" +
